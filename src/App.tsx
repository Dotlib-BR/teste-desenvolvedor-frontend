...
const App = () => {
  ...
  return (
    <main className="min-h-dvh w-full bg-zinc-800 p-4">
      <div className="container mx-auto flex min-h-[calc(100dvh-32px)] flex-col space-y-4 rounded-md bg-white p-4 py-4">
        <h1 className="text-2xl font-bold tracking-wide">Bulário Eletrônico</h1>
